          ...
          <div class="flex space-x-3">
            ...
            <a href="#" class="w-10 h-10 bg-white/20 hover:bg-secondary text-white flex items-center justify-center rounded-full transition-all duration-200 hover:scale-110 p-2" aria-label="Line">
              <svg viewBox="0 0 40 40" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg">
                <!-- 對話泡泡主體 - 優化形狀更接近 LINE 官方 logo -->
                <path
                  d="M20 4C10.6 4 3 10.05 3 17.5c0 6.61 5.8 12.18 13.62 13.24 0.53 0.12 1.25 0.35 1.44 0.81 0.16 0.42 0.11 1.07 0.05 1.5 0 0 -0.2 1.14 -0.23 1.38 -0.07 0.42 -0.33 1.64 0.7 0.89 1.03 -0.75 5.58 -3.32 7.61 -5.7 1.4 -1.54 3.75 -4.37 3.75 -9.12C30 10.05 29.4 4 20 4z"
                  fill="white"
                />
                <!-- LINE 文字 - 增加字體大小和粗細 -->
                <text
